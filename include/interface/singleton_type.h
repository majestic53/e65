...
namespace e65 {
	...
	namespace interface {
		...
		static const std::string E65_INTERFACE_SINGLETON_EXCEPTION_STR[] = {
			E65_INTERFACE_SINGLETON_EXCEPTION_HEADER "Singleton already initialized",
			E65_INTERFACE_SINGLETON_EXCEPTION_HEADER "Singleton failed to intiialize",
			E65_INTERFACE_SINGLETON_EXCEPTION_HEADER "Singleton already uninitialized",
			};
		...
		#define THROW_E65_INTERFACE_SINGLETON_EXCEPTION_FORMAT(_EXCEPT_, _FORMAT_, ...) \
			E65_THROW_EXCEPTION_FORMAT(E65_INTERFACE_SINGLETON_EXCEPTION_STRING(_EXCEPT_), _FORMAT_, __VA_ARGS__)

		enum {
			E65_SINGLETON_RUNTIME = 0,
		};

		#define E65_SINGLETON_MAX E65_SINGLETON_RUNTIME
