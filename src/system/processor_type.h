...
namespace e65 {
	...
	namespace system {
		...
		enum {
			...
			E65_SYSTEM_PROCESSOR_EXCEPTION_INVALID_COMMAND,
			E65_SYSTEM_PROCESSOR_EXCEPTION_INVALID_LENGTH,
			E65_SYSTEM_PROCESSOR_EXCEPTION_INVALID_MODE,
		...
		static const std::string E65_SYSTEM_PROCESSOR_EXCEPTION_STR[] = {
			...
			E65_SYSTEM_PROCESSOR_EXCEPTION_HEADER "Invalid command",
			E65_SYSTEM_PROCESSOR_EXCEPTION_HEADER "Invalid command length",
			E65_SYSTEM_PROCESSOR_EXCEPTION_HEADER "Invalid command mode",
			E65_SYSTEM_PROCESSOR_EXCEPTION_HEADER "Processor uninitialized",
			};
		...
		#define E65_PROCESSOR_REGISTER_ACCUMULATOR_RESET 0x00

		#define E65_PROCESSOR_REGISTER_FLAGS_RESET \
			(E65_PFLAG(e65::type::E65_PFLAG_BREAKPOINT) | E65_PFLAG(e65::type::E65_PFLAG_IRQ_DISABLE) \
				| E65_PFLAG(e65::type::E65_PFLAG_UNUSED))

		#define E65_PROCESSOR_REGISTER_INDEX_X_RESET 0x00
		#define E65_PROCESSOR_REGISTER_INDEX_Y_RESET 0x00

		#define E65_PROCESSOR_REGISTER_STACK_POINTER_BASE (UINT8_MAX + 1)
		#define E65_PROCESSOR_REGISTER_STACK_POINTER_RESET UINT8_MAX
	}
}
