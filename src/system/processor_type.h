...
namespace e65 {
	...
	namespace system {
		...
		enum {
			E65_SYSTEM_PROCESSOR_EXCEPTION_UNINITIALIZED = 0,
		};
		...
		#define E65_PROCESSOR_REGISTER_FLAGS (E65_PFLAG(E65_PFLAG_BREAKPOINT) | E65_PFLAG(E65_PFLAG_IRQ_DISABLE) | E65_PFLAG(E65_PFLAG_UNUSED))
