...
namespace e65 {
	...
	namespace system {
		...
		enum {
			E65_SYSTEM_VIDEO_EXCEPTION_POSITION = 0,
			E65_SYSTEM_VIDEO_EXCEPTION_UNINITIALIZED,
		};
		...
		static const std::string E65_SYSTEM_VIDEO_EXCEPTION_STR[] = {
			E65_SYSTEM_VIDEO_EXCEPTION_HEADER "Invalid pixel position",
			E65_SYSTEM_VIDEO_EXCEPTION_HEADER "Video uninitialized",
			};
		...
		#define E65_VIDEO_ADDRESS_MAX (((E65_VIDEO_WIDTH * E65_VIDEO_HEIGHT * sizeof(uint8_t)) - 1) + E65_VIDEO_ADDRESS_MIN)
